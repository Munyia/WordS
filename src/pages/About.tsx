    ...
    <section className="">
      ...
      <div className="max-w-screen-xl font-merri p-6 mt-24 sm:mt-18 text-center mx-auto sm:p-10">
        ...
        <div className="rounded-lg p-4 sm:p-8 shadow mb-10">
          <h2 className="text-2xl sm:text-3xl text-sec1 font-bold mb-4">Who We Are</h2>
          <p className="text-sm sm:text-lg">
            At Wordsmitters, we are storytellers, wordsmiths, and creators
            passionate about helping you share your voice with the world. With
    ...
    Connect with Us
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          <div className="rounded-lg p-4 sm:p-8 shadow">
            <h2 className="text-2xl sm:text-3xl text-sec1 font-bold mb-4">Our Mission</h2>
            <p className="text-sm sm:text-lg">
          ...
          <div className="rounded-lg p-4 sm:p-8 shadow">
            <h2 className="text-2xl sm:text-3xl text-sec1 font-bold mb-4">Our Vision</h2>
            <p className="text-sm sm:text-lg">
              To be the trusted partner for individuals and organizations
              seeking authentic, high-quality written works that leave a
              lasting impression.
            </p>
          </div>
        </div>
        ...
        <div className="mb-10">
          ...
          <ul className="space-y-4 text-sm sm:text-lg">
            <li className="flex items-start space-x-4">
              ...
              <p>Personalized Approach: Every project reflects your unique voice and vision.</p>
            </li>
            <li className="flex items-start space-x-4">
              <span className="text-sec1 text-lg sm:text-2xl font-bold">•</span>
            ...
            <li className="flex items-start space-x-4">
              <span className="text-sec1 text-lg sm:text-2xl font-bold">•</span>
              <p>Proven Expertise: A team of skilled writers dedicated to excellence.</p>
            </li>
          </ul>
        </div>
        ...
        {/* Meet the Team */}
        <div className="rounded-lg p-4 sm:p-8 shadow mb-10">
          <h2 className="text-2xl sm:text-3xl text-sec1 font-bold mb-4">Meet the Wordsmitters Team</h2>
          <p className="text-sm sm:text-lg">
    ...
    Connect with Us
        ...
        <div className="text-center">
          <p className="text-sm sm:text-xl font-semibold">
            Let <span className="text-sec1">Wordsmitters</span> shape your story today.
          </p>
        </div>
      </div>
    </section>
