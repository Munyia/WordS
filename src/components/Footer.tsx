          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-5 items-start">
            ...
            <div className="md:col-span-2">
              <div className="flex items-center space-x-2 mb-4">
                <img
                  className="w-48 align-top"
                  src={wg}
                  alt="Wordsmitters Logo"
                />
              </div>
              <p className="text-white mb-6 max-w-md">
                Your trusted partner in premium ghostwriting and content
                creation. We transform your ideas into compelling narratives
              ...
              <div className="space-y-3 text-sm mb-4">
                <div className="flex items-center space-x-2">
                  ...
                  <a
                    href="mailto:info@wordsmitters.com.ng"
                    className="hover:underline hover:text-sec1"
                  >
              ...
              <div className="hidden md:flex space-x-4 mt-2">
                <a
                  href="https://www.facebook.com/share/1HkXCNNz3M/?mibextid=wwXIfr"
                  target="_blank"
                ...
                <a
                  href="https://x.com/wordsmitters?s=11"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FaXTwitter
                ...
                <a
                  href="https://www.instagram.com/wordsmitters?igsh=a3hlMDNmMzV0MnE2&utm_source=qr"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FaInstagram
                ...
                <a
                  href="https://www.linkedin.com/company/wordsmitters/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FaLinkedin
                ...
                <a
                  href="https://wa.me/2347047223731"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FaWhatsapp
                    className="text-green-900 hover:opacity-80"
                    size={20}
                  />
                </a>
                <a
            ...
            <div className="md:col-span-1">
              <h3 className="font-semibold text-sec1 text-lg mb-4">
                Quick Links
              </h3>
              <ul className="space-y-2 text-sm">
                <li>
                  <Link to="/" className="text-white hover:text-pry transition">
                    Home
                  </Link>
                </li>
                <li>
                  <Link
                    to="/about"
                    className="text-white hover:text-sec1 transition"
                  >
                    About Us
                  </Link>
                </li>
    ...
    {[
        ...
        {service}
          ...
          <div className="border-t border-white/20 mt-12 pt-6 text-center text-sm">
            <p className="text-white opacity-80">
              © 2024 Wordsmitters. All rights reserved. Crafted with precision
              and passion.
            </p>
          </div>
        </div>
      ...
      <div className="fixed bottom-4 left-0 right-0 px-6 z-50 md:hidden flex justify-around items-center bg-transparent">
        ...
        <a
          ...
          rel="noopener noreferrer"
        >
          <FaWhatsapp className="text-green-900" size={24} />
        </a>
