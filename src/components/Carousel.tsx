...
interface CarouselProps {
  children: ReactNode[]; // Array of React elements (slides)
  autoslide?: boolean; // Optional prop to enable/disable auto-sliding
  autoslideinterval?: number; // Optional prop for auto-slide interval in milliseconds
}
